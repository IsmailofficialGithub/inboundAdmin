...
import { cilSearch, cilPhone, cilInfo, cilPencil, cilLink, cilPlus } from '@coreui/icons'
        ...
        <CForm onSubmit={handleCreate}>
          <CModalBody style={{ maxHeight: '70vh', overflowY: 'auto' }}>
            ...
            <div className="mb-3">
              ...
              {selectedUser && (
                <div className="mt-2">
                  <CBadge color="success">Selected: {selectedUser.email}</CBadge>
                </div>
              )}
            </div>
          ...
          <CModalFooter>
            ...
            <CButton 
              type="submit" 
              color="primary" 
              disabled={createLoading || !selectedUser || !selectedCredentialId}
            >
              {createLoading ? (
                <>
          ...
          {(!selectedUser || !selectedCredentialId) && (
